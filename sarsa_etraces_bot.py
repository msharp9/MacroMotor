...
class SarsaBot(sc2.BotAI):
    def __init__(self, action_space=None, learning_rate=0.01, reward_decay=0.9,
        e_greedy=0.9, trace_decay=0.8, model=None, title=1, record="records/sarsa_etrace-record.txt"):
        self.MAX_WORKERS = 50
    ...
    def on_end(self, game_result):
        ...
        if self.model:
            ...
            self.q_table.to_csv('model/sarsa_etrace_model.csv')
    ...
    def intel(self):
        ...
        resized = cv2.resize(self.flipped, dsize=None, fx=0.33, fy=0.33)
...
if __name__ == "__main__":
    ...
    #         Bot(Race.Protoss, SarsaBot(model='model/sarsa_etrace.csv',
